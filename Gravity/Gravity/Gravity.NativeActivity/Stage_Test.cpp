...
Stage_Test::Stage_Test() {
	...
	player[0] = std::make_shared<Player>(200, 500, 5, 8, 0.5);						//引数(初期x座標, 初期y座標, 電荷, 体積, 密度)//初期座標は別ファイルから読み取るのがいいかもしれない
	player[1] = std::make_shared<Player>(900, 1000, 15, 8, 0.5);
	player[2] = std::make_shared<Player>(800, 1300, -3, 8, 0.5);
